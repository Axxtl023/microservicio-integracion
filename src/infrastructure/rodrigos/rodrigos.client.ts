...
// ⚠️ Riesgo de cutover V1→V2 (Rodrigo Lucano):
// El contrato V2 mueve los paths a `/api/v2/...` pero MANTIENE el mismo host
// en Render. Si Rodrigo apaga `/api/v1/...` al desplegar V2, este cliente va
// a empezar a recibir 404. Acción cuando V2 esté en cutover: actualizar
// RODRIGOS_API_URL al nuevo path o agregar fallback v2→v1 acá.
